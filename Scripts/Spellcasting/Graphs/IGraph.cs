...
public interface ISpellGraphNode : IGraphNode
{
    ...
    /// </summary>
    ///  
    public List<Sigil> Sigils { get; set; }
...
public interface IGraph<T> : ICollection<T> where T : IGraphNode
{
...
public interface ISpellGraph<T> : IGraph<T> where T : ISpellGraphNode
{
